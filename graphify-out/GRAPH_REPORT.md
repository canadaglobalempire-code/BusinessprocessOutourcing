...
## Corpus Check
- 58 files · ~814,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 313 nodes · 445 edges · 29 communities (22 shown, 7 thin omitted)
...
Cohesion: 0.09
Nodes (21): metadata, STATEMENTS, metadata, metadata, STEPS, ACCENTS, IndustriesPage(), industryOptions() (+13 more)
...
Cohesion: 0.06
Nodes (30): motion, next, dependencies, motion, next, react, react-dom, devDependencies (+22 more)

### Community 3 - "Community 3"
Cohesion: 0.10
Nodes (20): ContactPage(), metadata, generateMetadata(), Params, ServiceDetail(), AGENT_COUNTS, CALL_CENTRE_SERVICES, CALL_VOLUMES (+12 more)
...
Cohesion: 0.08
Nodes (33): ACCENTS, generateMetadata(), generateStaticParams(), IndustryDetail(), Params, inter, metadata, structuredData (+25 more)
...
## Knowledge Gaps
- **161 isolated node(s):** `metadata`, `STATEMENTS`, `Params`, `metadata`, `metadata` (+156 more)
